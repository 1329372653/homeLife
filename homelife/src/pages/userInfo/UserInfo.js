    ...
    render() {
        return (<div className='userInfo_content'>
            ...
            <div className='userInfo_right_content'>
                ...
                <div className='user_form_item'>
                    <label>简介：</label>
                    <textarea className='bio_input' name='bio' value={this.state.bio} onChange={this.handleBio}></textarea>
                </div>
                <div className='user_form_item'>
                    <label>性别：</label>
                    <input className='gender_input' type='radio' value='-1' name="gender" onChange={this.handleGender} />男
                        <input className='gender_input' type='radio' value='1' name="gender" onChange={this.handleGender} />女
                        <input className='gender_input' type='radio' value='0' name="gender" onChange={this.handleGender} />保密
                    </div>
                <div className='user_form_item'>
                    <label>头像设置：</label>
